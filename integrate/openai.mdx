...
The [OpenAI loop example](https://github.com/ashtonchew/modal-computer-use/blob/main/examples/03_openai_computer_loop.py) contains the complete preflight, timeout, batching, screenshot reuse, and cleanup logic.
