...
The [view-only example](https://github.com/ashtonchew/modal-computer-use/blob/main/examples/novnc_view_only.py) reports only whether a URL exists. It does not print the URL.
