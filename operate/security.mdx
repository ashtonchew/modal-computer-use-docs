...
Use the [view-only example](https://github.com/ashtonchew/modal-computer-use/blob/b60c1cb7495200e36a738c0f6e07961b1d2db93c/examples/novnc_view_only.py) to create a desktop with view-only noVNC access. The example reports URL availability while keeping the URL secret.
...
Report a product vulnerability through the repository [security policy](https://github.com/ashtonchew/modal-computer-use/blob/b60c1cb7495200e36a738c0f6e07961b1d2db93c/SECURITY.md).
