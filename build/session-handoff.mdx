...
Read the [complete executable example](https://github.com/ashtonchew/modal-computer-use/blob/main/examples/modal_function_session_handoff.py) before you add dispatch, cancellation, or recovery logic.
