...
## Article performance claims

| Claim | Status | Measurement boundary | Proof |
| --- | --- | --- | --- |
| Warm screenshots, clicks, typing, and commands | Historical | 30 successful warm samples per path and case after target and client readiness | [Warm-path report](https://github.com/ashtonchew/modal-computer-use/blob/4425402dbc681133252dbc54d971ea4c95bc0ffc/docs/benchmark-results-2026-07-30-warm-paths.md) |
...
The dated warm-path report also supports the article's separate-operation arithmetic. Keep that explanation with the dated evidence.
