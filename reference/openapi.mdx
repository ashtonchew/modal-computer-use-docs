...
The daemon publishes an OpenAPI 3.1 contract. The checked-in schema reports package version `2.0.1`.
...
The command fails when [`docs/openapi.json`](https://github.com/ashtonchew/modal-computer-use/blob/b60c1cb7495200e36a738c0f6e07961b1d2db93c/docs/openapi.json) differs from the daemon application.
